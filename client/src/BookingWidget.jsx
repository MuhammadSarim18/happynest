...
export default function BookingWidget({ place }) {
    ...
    return (
        <div className="bg-white shadow-lg p-4 rounded-2xl">
            ...
            <button onClick={bookThisPlace} className="primary my-4">
                Book this place
            </button>
            <div className="text-2xl p-2 flex justify-around border-t">
            {numberOfNights > 0 && (
                    <span>Total  $<span>{numberOfNights * place.price}</span></span>
                )}
            </div>
        </div>
    )
