...
export default function RegisterPage() {
    ...
    async function registerUser(ev) {
        ...
        try {
            ...
            alert('Registration Failede. Please try again later!')
        }
    ...
    return (
        ...
        //             <input type="email"
        //                 placeholder="your@gmail.com" value={email}
        ...
        //             <div className="text-center py-0 text-gray-500">Already a member? <Link className="underline text-black" to={'/login'}>Login Now</Link>
        //             </div>
        //         </form>
        //     </div>
        <div className="min-w-screen min-h-screen mt-16  flex items-center justify-center px-5 py-5">
                                    ...
                                    <div className="w-1/2 px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mdi mdi-account-outline text-gray-400 text-lg">
